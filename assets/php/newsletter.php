<?php
    ...
    if (empty($_POST['mensaje']) && empty($_POST['asunto'])) {
        ...
        $mensaje = mysqli_real_escape_string($conn, preg_replace("/[[:space:]]/"," ",trim($_POST['mensaje'])));
        $asunto = mysqli_real_escape_string($conn, preg_replace("/[[:space:]]/"," ",trim($_POST['asunto'])));

        $consulta = mysqli_query($conn, "SELECT * FROM newsletter ");
        ...
        if($validacion > 0){
            ...
            while($datos = mysqli_fetch_array($consulta)){
                ...
                $id_user = $datos['user_id'];

                $consulta_user = mysqli_query($conn, "SELECT * FROM users WHERE id = $id_user");
                $info_user = mysqli_fetch_array($consulta_user);

                $email = $info_user['email'];
                $nombre = $info_user['name'];
                ...
                try {
                    ...
                    $mail->Body    = "<!DOCTYPE html>
                                        <html lang='es'>
                                            ...
                                            <body>
                                                <table class='email-wrapper' width='100%' cellpadding='0' cellspacing='0' style='box-sizing: border-box; font-family: Arial, Helvetica, sans-serif; margin: 0; padding: 0; width: 100%; background-color:#F2F4F6'>
                                                    <tr>
                                                            ...
                                                            <table class='email-content' width='100%' cellpadding='0' cellspacing='0' style='box-sizing: border-box; font-family: Arial, Helvetica, sans-serif; margin: 0; padding: 0; width: 100%;'>
                                                                <tr>
                                                                    <td class='email-masthead' style='box-sizing: border-box; font-family: Arial, Helvetica, sans-serif; padding: 25px 0; word-break: break-word;' align='center'>
                                                                        <a class='ancla-softtech' href='https://softech.cesenas.com/' class='email-masthead_name' style='box-sizing: border-box; color: #bbbfc3; font-family: Arial, Helvetica, sans-serif; font-size: 16px; font-weight: bold; text-decoration: none; text-shadow: 0 1px 0 white;'>
                                                                            SofTech
                                                                        </a>
                                                                    </td>
                                                                </tr>
                                                                        ...
                                                                        <table class='email-body_inner' align='center' width='570' cellpadding='0' cellspacing='0' style='box-sizing: border-box; font-family: Arial, Helvetica, sans-serif; margin: 0 auto; padding: 0; width: 570px;' bgcolor='#FFFFFF'>
                                                                            <tr>
                                                                                <td class='content-cell' style='box-sizing: border-box; font-family: Arial, Helvetica, sans-serif; padding: 35px; word-break: break-word;'>
                                                                                    <h1 style='box-sizing: border-box; color: #2F3133; font-family: Arial, Helvetica, sans-serif; font-size: 19px; font-weight: bold; margin-top: 0;' align='left'>Hola $nombre $apellido.</h1>
                                                                                    <p style='box-sizing: border-box; color: #74787E; font-family: Arial, Helvetica, sans-serif; font-size: 16px; line-height: 1.5em; margin-top: 0;' align='left'>$mensaje .</p>
                                                                                </td>
                                                                            </tr>
                                                                        </table>
                                                                    </td>
                                                                            ...
                                                                            <tr>
                                                                                <td class='content-cell' align='center' style='box-sizing: border-box; font-family: Arial, Helvetica, sans-serif; padding: 35px; word-break: break-word;'>
                                                                                    <p class='sub align-center' style='box-sizing: border-box; color: #AEAEAE; font-family: Arial, Helvetica, sans-serif; font-size: 12px; line-height: 1.5em; margin-top: 0;' align='center'>
                                                                                        © $anio SofTech. Todos los derechos reservados.
                                                                                    </p>
                                                                                </td>
                                                                            </tr>
                                                                        </table>
