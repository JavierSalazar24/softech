...
<section id="topbar" class="d-flex align-items-center">
  ...
  <header id="header" class="d-flex align-items-center">
    <div class="container d-flex align-items-center">
      <a href="./" class="logo me-auto"><img src="assets/img/logo.png" alt="Logo de la empresa" id="img_logo" class="img-fluid"></a>
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <?php if(isset($_SESSION['usuarioSocial'])){ ?>
            <li class="dropdown"><a href="#"><span><?php echo $_SESSION["usuarioSocial"]["first_name"].' '.$_SESSION["usuarioSocial"]["last_name"] ?></span> <i class="bi bi-chevron-down"></i></a>
              <ul>
                <li><a href="#">Ver post</a></li>
          ...
          <li>
            <form class="form-inline my-2 my-lg-0 d-flex" action="busqueda" method="post">
              <input id="search-bar" class="form-control mr-sm-2" type="search" placeholder="Búsqueda" aria-label="Search"
                name="q" required minlength="3" value="<?php if(isset($busqueda)){ echo $busqueda; } ?>">
