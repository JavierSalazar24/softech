      ...
      <div class="row">
        ...
        <div class="col-lg-3 col-xs-12 links">
          ...
          <ul class="m-0 p-0 footerlinks">
            <li class="mb-2"><a href="seccion?sec=Videojuegos">Sección Videojuegos</a></li>
            <li class="mb-2"><a href="seccion?sec=Software">Sección Software</a></li>
            <li class="mb-2"><a href="seccion?sec=Windows">Sección Windows</a></li>
            <li class="mb-2"><a href="seccion?sec=Mac">Sección Mac</a></li>
            <li class="mb-2"><a href="seccion?sec=Linux">Sección Linux</a></li>
            <li class="mb-2"><a href="seccion?sec=Android">Sección Android</a></li>
            <li class="mb-2"><a href="seccion?sec=iOS">Sección iOS</a></li>
            <li class="mb-2"><a href="privacidad">Política de privacidad</a></li>
            <li class="mb-2"><a href="terminos">Términos y condiciones</a></li>
            <li class="mb-2"><a href="sitemap">Mapa del sitio</a></li>
            <!-- <li class="mb-2"><a href="manual">Manual de usuario</a></li> -->
            <?php if(isset($_SESSION['usuarioblog'])){ ?>
              <li class="mb-2"><a href="../perfil" target="_blank" >Perfil</a></li>
              <p></p>
            <?php }else if(isset($_SESSION['admin'])){ ?>
              <li class="mb-2"><a href="../perfil" target="_blank" >Perfil</a></li>
              <li class="mb-2"><a href="posts" target="_blank" >Ver posts</a></li>
              <li class="mb-2"><a href="autores" target="_blank" >Ver autores</a></li>
              <li class="mb-2"><a href="newsletter" target="_blank" >Newsletter</a></li>
              <li class="mb-2"><a href="imgs">Imagenes del carrusel</a></li>
        ...
        <div class="col-lg-4 col-xs-12 location">
          ...
          <ul class="m-0 p-0 footerlinks">
            ...
            <li class="mb-3"><a class="link-footer" href="mailto:mensajesoftech@gmail.com"><i
